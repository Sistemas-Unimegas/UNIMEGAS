...
import odoo.tests
from odoo.addons.point_of_sale.test import test_fontend as pos_test
from odoo.addons.pos_restaurant.test import test_fontend as restaurant_test
import logging

_logger = logging.getLogger(__name__)

@odoo.tests.tagged('post_install', '-at_install')
class TestUi(pos_test):
...
@odoo.tests.tagged('post_install', '-at_install')
class TestFrontend(restaurant_test):
