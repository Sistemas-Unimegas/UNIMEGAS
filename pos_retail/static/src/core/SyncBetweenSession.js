    ...
    exports.pos_bus = Backbone.Model.extend({
        ...
        register_point: function () { // TODO: register point to IoT Boxes
            ...
            for (var i = 0; i < this.pos.iot_connections.length; i++) { //
                ...
                console.log('sync via IP: ' + iot_connection.origin);
                var params = {
            ...
            setTimeout(_.bind(this.register_point, this), 3000)
        },
        ...
        send_notification: function (value) {
            ...
            this.pos.config.sync_to_pos_config_ids = _.filter(this.pos.config.sync_to_pos_config_ids, function (config_id) {
                return config_id != self.pos.config.id
            });
            var params = {
                database: this.pos.session.db,
