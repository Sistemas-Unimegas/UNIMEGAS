...
odoo.define('pos_retail.backup_orders', function (require) {
    ...
    var ButtonBackupOrder = screens.ActionButtonWidget.extend({ // combo button
        template: 'ButtonBackupOrder',
        button_click: function () {
            return this.pos.gui.show_popup('popup_backup_orders', {})
        }
    });

    screens.define_action_button({
        'name': 'ButtonBackupOrder',
        'widget': ButtonBackupOrder,
        'condition': function () {
            return this.pos.config.backup;
        }
    });
