...
odoo.define('pos_retail.screen_products_operation', function (require) {
    ...
    var ProductOperationScreenHeader = chrome.StatusWidget.extend({
        template: 'ProductOperationScreenHeader',
        init: function () {
            var self = this;
        ...
        start: function () {
            ...
            this.$el.click(function () {
                self.pos.gui.show_screen('products_operation');
            });
        }
    });
    ...
    chrome.Chrome.include({
        build_widgets: function () {
            if (this.pos.config.product_operation) {
                this.widgets.push(
                    {
                        'name': 'ProductOperationScreenHeader',
                        'widget': ProductOperationScreenHeader,
