...
odoo.define('pos_retail.screen_products_return', function (require) {
    ...
    var RefundProductScreenHeader = chrome.StatusWidget.extend({
        template: 'RefundProductScreenHeader',
        init: function () {
            var self = this;
        ...
        start: function () {
            ...
            this.$el.click(function () {
                self.pos.gui.show_screen('return_products');
            });
        }
    });
    chrome.Chrome.include({
        build_widgets: function () {
            if (this.pos.config.return_products) {
                this.widgets.push(
                    {
                        'name': 'RefundProductScreenHeader',
                        'widget': RefundProductScreenHeader,
